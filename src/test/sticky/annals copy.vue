      ...
      <div class="content-side">
        <div class="text-wrapper">
          ...
          <div class="button-group">
            <el-button class="annals-btn primary-btn" round @click="$router.push('/annals')">前往纪年馆</el-button>
            <el-button class="annals-btn secondary-btn" round @click="$router.push('/releases')">前往作品馆</el-button>
          </div>
...
<script>
import stickyMixin from '@/test/sticky/sticky mixin copy.js'
